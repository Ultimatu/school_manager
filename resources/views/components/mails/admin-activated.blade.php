    ...
    <table class="panel" width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
            <td class="panel-content">
               ...
               @if ($action === "created")
               <p class="panel-item break-all">Un administrateur a activé votre compte sur la plateforme <strong>UTA School GENIUS</strong> en tant  que administrateur.</p>
               @else
               <p class="panel-item break-all">Un administrateur a mis à jour votre compte sur la plateforme <strong>UTA School GENIUS</strong> en tant  que administrateur.</p>
               @endif
