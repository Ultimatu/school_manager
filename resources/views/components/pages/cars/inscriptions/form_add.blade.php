...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ $inscription->id ? 'Modifier' : 'Ajouter' }}</li>
        </ol>
    </nav>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('car_inscriptions.storeVersement', $inscription->id) }}">
                            @csrf
                            <div class="row mb-3">
